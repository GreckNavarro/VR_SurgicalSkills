...
public class XRControllerInput : MonoBehaviour
{
    ...
    public static Action leftThumbrestPressed;
    ...
    public static Action leftThumbrestHeld;
    ...
    public static Action leftThumbrestReleased;
    ...
    public static Action rightThumbrestPressed;
    ...
    public static Action rightThumbrestHeld;
    ...
    public static Action rightThumbrestReleased;
    ...
    void SetUpActions()
    {
        ...
        leftPressedActions[1] += () => { leftThumbrestPressed?.Invoke(); };
        ...
        leftHeldActions[1] += () => { leftThumbrestHeld?.Invoke(); };
        ...
        leftReleasedActions[1] += () => { leftThumbrestReleased?.Invoke(); };
        ...
        rightPressedActions[1] += () => { rightThumbrestPressed?.Invoke(); };
        ...
        rightHeldActions[1] += () => { rightThumbrestHeld?.Invoke(); };
        ...
        rightReleasedActions[1] += () => { rightThumbrestReleased?.Invoke(); };
